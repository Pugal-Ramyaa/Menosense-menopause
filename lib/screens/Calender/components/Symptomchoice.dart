...
class SymptomsChoice extends StatefulWidget {
  @override
  _SymptomsChoiceState createState() => _SymptomsChoiceState();
}
class _SymptomsChoiceState extends State<SymptomsChoice> {
